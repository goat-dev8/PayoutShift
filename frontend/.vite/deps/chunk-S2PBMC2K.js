...
var ICONS = {
  add: async () => (await import("./add-UFMNRUDM.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GZGIT5HD.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-7V55E53A.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-UI34FSIM.js")).appStoreSvg,
  apple: async () => (await import("./apple-2IPN4LKD.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-V5VKINJL.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-XZQGMTGV.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-VJ3NNUTS.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-2JTHSYNH.js")).arrowTopSvg,
  bank: async () => (await import("./bank-OKCH2A3E.js")).bankSvg,
  browser: async () => (await import("./browser-S53IQEJL.js")).browserSvg,
  card: async () => (await import("./card-HA7626A4.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-QHOZBBU5.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-S6SZ7JKD.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-LS3L6OUV.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-E2Y63BHV.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-CZJXMD7I.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-3E5PIV3N.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-XK5GFL7J.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-EWELUX6R.js")).clockSvg,
  close: async () => (await import("./close-ISCZ5E35.js")).closeSvg,
  compass: async () => (await import("./compass-5E7HPBMZ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-RERENGMR.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-6HG22TDW.js")).copySvg,
  cursor: async () => (await import("./cursor-4ZPRXTO4.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-S7L6BID5.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-MGT55VGB.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-ERBPDTLI.js")).disconnectSvg,
  discord: async () => (await import("./discord-4CUNZ6JO.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-FHQAXE3S.js")).etherscanSvg,
  extension: async () => (await import("./extension-276LEXWM.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-UC2LDY3E.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-JKYSA33D.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ERXQUBKC.js")).farcasterSvg,
  filters: async () => (await import("./filters-CZ6TXGU4.js")).filtersSvg,
  github: async () => (await import("./github-TSDDYG3C.js")).githubSvg,
  google: async () => (await import("./google-KYEJUOTF.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-IUJVBLGA.js")).helpCircleSvg,
  image: async () => (await import("./image-R5Q4DQGW.js")).imageSvg,
  id: async () => (await import("./id-CEOH5TMZ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-27EX3GQF.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-UGJ227UD.js")).lightbulbSvg,
  mail: async () => (await import("./mail-SYSWJCRJ.js")).mailSvg,
  mobile: async () => (await import("./mobile-BY5AM6VK.js")).mobileSvg,
  more: async () => (await import("./more-ZA276UKG.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-KPSPFPTG.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CCHF6TFJ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-EXEGSJ2P.js")).offSvg,
  playStore: async () => (await import("./play-store-JY4URTKX.js")).playStoreSvg,
  plus: async () => (await import("./plus-K2KPFD3C.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-RGUXH4I7.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-DQBZAUAY.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-KFNCZZS2.js")).refreshSvg,
  search: async () => (await import("./search-P6V4YFVJ.js")).searchSvg,
  send: async () => (await import("./send-OMXFPK6Z.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RHUOD5QG.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-WJIEWICI.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Y2E4VKK7.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-4IB5ACSD.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-AJ6BKZ63.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-HDPBQE4X.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-E2NCLRSV.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-JFLTS65K.js")).twitchSvg,
  twitter: async () => (await import("./x-GFZPIICX.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-QFRK53UX.js")).twitterIconSvg,
  verify: async () => (await import("./verify-PYVA76X5.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-5CE7H6GI.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GSA5IBJ4.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-BQVEXEOR.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-BQVEXEOR.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-BQVEXEOR.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-NKXHICX2.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-HFB5S5BD.js")).warningCircleSvg,
  x: async () => (await import("./x-GFZPIICX.js")).xSvg,
  info: async () => (await import("./info-Z7CI7XWU.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-SWD7RPMW.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-LJESKRAO.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S2PBMC2K.js.map
